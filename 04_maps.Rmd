...
- <span style="color:white">Strech goal: Show all 50 states including Alaska and Hawaii. See the description for [`fiftystater`](https://github.com/wmurphyrd/fiftystater).
</span>
...
- <span style="color:white">Use the accident data to plot the geographic location of all accidents in the US in 2017.
</span>
